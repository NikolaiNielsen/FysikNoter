...
\begin{document}
	...
	\end{equation}
	Findes disse fire partielt afledte, og de er kontinuerte og opfylder relationen ovenfor, er det en \textbf{tilstrækkelig} betingelse for at funktionen $ f $ er differentiabel i $ z $. Med andre ord: hvis de eksisterer, er kontinuerte og opfylder relationen, så er $ f $ uden tvivl differentiabel i $ z $.
