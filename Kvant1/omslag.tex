...
\begin{document}
	...
	\begin{tabular}[H]{>{\vspace{0.4cm}} l >{$\displaystyle} c <{$}}
		...
		Tidsafhængighed af forventningsværdi & \diff[d]{\langle Q \rangle}{t} = \frac{i}{\hbar} \langle [H,Q]\rangle + \brac[\bigg]{\diff{Q}{t}}\\
	...
	\begin{tabular}[H]{>{\vspace{0.4cm}} l <{\hspace{1cm}} >{$} r <{$}  l <{=} >{$} l <{$}}
		Planks (reducerede) konstant & \hbar && 1.05457 \D 10^{-34} \e{J s} \\
