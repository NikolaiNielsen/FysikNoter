...
%		v & = \frac{\lambda}{T} = \frac{\omega}{k} = \frac{2 \pi}{k T}, \\
	...
	\begin{equation}\label{key}
		v = \frac{1}{\sqrt{\epsilon\mu}} = \frac{c}{n}, \quad n = \sqrt{\frac{\epsilon\mu}{\epsilon_0 \mu_0}}
	\end{equation}
	...
	\begin{equation}\label{key}
		\T{E}_{0_I} - \T{E}_{0_R} = \beta\T{E}_{0_T}, \quad \beta = \frac{\mu_1 v_1}{\mu_2 v_2} = \frac{\mu_1 n_2}{\mu_2 n_1}
	\end{equation}
	...
	\begin{equation}\label{key}
		R = \frac{I_R}{I_I} = \pp{\frac{E_{0_R}}{E_{0_I}}}^2 = \pp{\frac{n_1-n_2}{n_1+n_2}}^2,
	\end{equation}
	og brøkdelen der transmitteres er
	\begin{equation}\label{key}
		T = \frac{I_T}{I_I} = \frac{\epsilon_2 v_2}{\epsilon_1 v_1} \pp{\frac{E_{0_T}}{E_{0_I}}}^2 = \frac{4 n_1 n_2}{(n_1+n_2)^2},
	\end{equation}
	...
	\begin{equation}\label{key}
		\T{E}_{0_R} = \frac{\alpha-\beta}{\alpha+\beta} \T{E}_{0_I}, \quad \T{E}_{0_T} = \frac{2}{\alpha+\beta} \T{E}_{0_I}, \quad \alpha = \frac{\cos \theta_T}{\cos \omega_I}, \quad \beta = \frac{\mu_1 v_1}{\mu_2 v_2} = \frac{\mu_1 n_2}{\mu_2 n_1}
	\end{equation}
	...
	\begin{align}
		R &= \frac{I_R}{I_I} = \pp{\frac{E_{0_R}}{E_{0_I}}}^2 = \pp{\frac{\alpha-\beta}{\alpha+\beta}}^2, \\
		T &= \frac{I_T}{I_I} = \frac{\epsilon_2 v_2 \cos \theta_T}{\epsilon_1 v_1 \cos \theta_I} \pp{\frac{E_{0_T}}{E_{0_I}}}^2 = \alpha \beta \pp{\frac{2}{\alpha + \beta}}^2.
	\end{align}
	...
	\subsection{Absorbering og svækkelse, elektromagnetiske bølger i ledere}
\end{document}