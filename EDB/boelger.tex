...
%		v & = \frac{\lambda}{T} = \frac{\omega}{k} = \frac{2 \pi}{k T}, \\
	...
	\begin{figure}[H]
		...
		\label{fig:2dWave}
		\caption{Et plot af $ 2 \sin(2r)/r $ for $ x,y = [-4\pi,4\pi] $. MATLAB-koden kan hentes fra min GitHub: https://github.com/NikolaiNielsen/FysikNoter/blob/master/EDB/2dWaves.m}
	\end{figure}
