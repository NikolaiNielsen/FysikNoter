...
\begin{document}
	...
	\end{align}
 	...
 	\begin{equation}
	 	\langle P \rangle = \frac{\emf^2_0 R}{2|Z|^2} = \frac{1}{2} |\T{I}_0|^2 R
 	\end{equation}
 	hvor $ \emf_0 $ og $ \T{I}_0 $ er amplituden for henholdsvis den elektromotoriske kraft og strømmen. Det ses, at der er en faktor 1/2 til forskel fra jævnstrømstilfældene, hvor $ P = \emf I = \emf^2 / R = I^2 R $. Derfor introduceres ofte de ">effektive amplituder"< for strømmen og den elektromotoriske kraft:
 	\begin{equation}\label{key}
