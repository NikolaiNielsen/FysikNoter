...
\begin{document}
	...
	I dette afsnit behandles kun strålingen fra elektriske dipoler. Der ses på to små metalsfærer, som befinder sig på $ z $-aksen i en afstand $ d $ fra hinanden, med en lige ledning mellem dem. Hvis der drives ladninger harmonisk op og ned af ledningen, med vinkelfrekvensen $ \omega $ fås
	\begin{equation}
		q(t) = q_0 \cos \omega t,
	\end{equation}
