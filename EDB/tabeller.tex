...
\begin{document}
	...
	\begin{equation}\label{key}
		\epsilon_r = \frac{\epsilon}{\epsilon_0}, \quad \epsilon_0 = 8.85\D 10^{-12} \ \e{C}^2 / \e{Nm}^2
	\end{equation}
	...
	\begin{table}[H]
		...
		\begin{tabular}{llll}
			...
			Vanddamp (100$ \degree $ C)	& 1.00587 				& KTaNbO$ _3 $ (0$ \degree $ C)	& $ 34\D 10^3 $ \\ \hline
		\end{tabular}
	...
	\begin{equation}\label{key}
		\mu = \mu_0 (1+\chi_m), \quad \mu_0 = 4\pi \D 10^{-7} \ \e{N}/\e{A}^2
	\end{equation}
	...
	\begin{table}[H]
		...
		\begin{tabular}{*{2}{l >{$} r <{$}}}
			...
			Kviksølv 	& 1.04 \D 10^{6} & Vand (rent) 			& 4.0 \D 10^{-6} \\
