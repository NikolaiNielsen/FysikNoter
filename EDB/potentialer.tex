...
\begin{document}
	...
	\paragraph{Coulombgaugen.} Som i magnetostatik vælges, at $ \diverg{A} = 0 $. Dette giver at ligning \eqref{eq_genPoisson} reducerer til Poissons ligning:
	\begin{equation}\label{key}
	...
	\end{equation}
	hvor $ \bsr = \V{r}-\V{w}(t_r) $, $ \V{u} \equiv c \usr - \V{v} $ og $ \V{a} $ er kildepartiklen $ q $'s accelerationsvektor. Det ses ud fra krydsproduktet i B-feltet, at dette altid er vinkelret på både det elektriske felt og vektoren fra det retarderede punkt.
